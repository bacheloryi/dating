...
export const MARD_PALETTE = [
  ...
  { code: 'P1', hex: '#FCF7F8' }, { code: 'P2', hex: '#B0A9AC' }, { code: 'P3', hex: '#AFDCAB' },
  { code: 'P4', hex: '#FEA49F' }, { code: 'P5', hex: '#EE8C3E' }, { code: 'P6', hex: '#5FD0A7' },
  { code: 'P7', hex: '#EB9270' }, { code: 'P8', hex: '#F0D958' }, { code: 'P9', hex: '#D9D9D9' },
  { code: 'P10', hex: '#D9C7EA' }, { code: 'P11', hex: '#F3ECC9' }, { code: 'P12', hex: '#E6EEF2' },
  { code: 'P13', hex: '#AACBEF' }, { code: 'P14', hex: '#337680' }, { code: 'P15', hex: '#668575' },
  { code: 'P16', hex: '#FEBF45' }, { code: 'P17', hex: '#FEA324' }, { code: 'P18', hex: '#FEB89F' },
  { code: 'P19', hex: '#FFFEEC' }, { code: 'P20', hex: '#FEBECF' }, { code: 'P21', hex: '#ECBEBF' },
  { code: 'P22', hex: '#E4A89F' }, { code: 'P23', hex: '#A56268' },
  { code: 'Q1', hex: '#F2A5E8' }, { code: 'Q2', hex: '#E9EC91' }, { code: 'Q3', hex: '#FFFF00' },
  { code: 'Q4', hex: '#FFEBFA' }, { code: 'Q5', hex: '#76CEDE' },
  { code: 'R1', hex: '#D50D21' }, { code: 'R2', hex: '#F92F83' }, { code: 'R3', hex: '#FD8324' },
  { code: 'R4', hex: '#F8EC31' }, { code: 'R5', hex: '#35C75B' }, { code: 'R6', hex: '#238891' },
  { code: 'R7', hex: '#19779D' }, { code: 'R8', hex: '#1A60C3' }, { code: 'R9', hex: '#9A56B4' },
  { code: 'R10', hex: '#FFDB4C' }, { code: 'R11', hex: '#FFEBFA' }, { code: 'R12', hex: '#D8D5CE' },
  { code: 'R13', hex: '#55514C' }, { code: 'R14', hex: '#9FE4DF' }, { code: 'R15', hex: '#77CEE9' },
  { code: 'R16', hex: '#3ECFCA' }, { code: 'R17', hex: '#4A867A' }, { code: 'R18', hex: '#7FCD9D' },
  { code: 'R19', hex: '#CDE55D' }, { code: 'R20', hex: '#E8C7B4' }, { code: 'R21', hex: '#AD6F3C' },
  { code: 'R22', hex: '#6C372F' }, { code: 'R23', hex: '#FEB872' }, { code: 'R24', hex: '#F3C1C0' },
  { code: 'R25', hex: '#C9675E' }, { code: 'R26', hex: '#D293BE' }, { code: 'R27', hex: '#EA8CB1' },
  { code: 'R28', hex: '#9C87D6' },
  { code: 'T1', hex: '#FFFFFF' },
  { code: 'Y1', hex: '#FD6FB4' }, { code: 'Y2', hex: '#FEB481' }, { code: 'Y3', hex: '#D7FAA0' },
  { code: 'Y4', hex: '#8BDBFA' }, { code: 'Y5', hex: '#E987EA' },
  { code: 'ZG1', hex: '#DAABB3' }, { code: 'ZG2', hex: '#D6AA87' }, { code: 'ZG3', hex: '#C1BD8D' },
  { code: 'ZG4', hex: '#96869F' }, { code: 'ZG5', hex: '#8490A6' }, { code: 'ZG6', hex: '#94BFE2' },
  { code: 'ZG7', hex: '#E2A9D2' }, { code: 'ZG8', hex: '#AB91C0' },
];
...
/** 预计算 Lab 值，加速最近色匹配 */
export const PALETTE_LAB = MARD_PALETTE.map((color) => {
